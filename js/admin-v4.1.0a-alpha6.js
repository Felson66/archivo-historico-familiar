...
function renderWorkspaceVisibility(tab){
  photosWorkspace.classList.toggle("hidden",tab!=="photos");
  documentsWorkspace.classList.toggle("hidden",tab!=="documents");
  biographyWorkspace.classList.toggle("hidden",tab!=="biography");
}
