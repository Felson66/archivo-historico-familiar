...
async function renderManager(){
  ...
  biographyPanel.classList.toggle("hidden",activeTab!=="biography");
  ...
  if(!items.length){
    galleryEmpty.textContent=activeTab==="photos"?"Esta persona todavía no tiene fotografías.":"Esta persona todavía no tiene documentos archivados.";
